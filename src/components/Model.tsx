...
const Model = () => {
    ...
    // camra control for the model view
    const cameraControlSmall = useRef<React.Ref<THREE.Group<THREE.Object3DEventMap>> |undefined>()
    const cameraControlLarge = useRef<React.Ref<THREE.Group<THREE.Object3DEventMap>> |undefined>()
    // model
